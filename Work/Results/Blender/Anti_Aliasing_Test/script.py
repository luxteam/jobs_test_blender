...
def render(*argv):
	...
	output = r"C:\jobs_test_blender\Work\Results\Blender\Anti_Aliasing_Test" + "/Color/" + name_scene + "_##"
	...
	log_name = os.path.join(r'C:\jobs_test_blender\Work\Results\Blender\Anti_Aliasing_Test', name_scene_for_json + ".json")
	report = {}
