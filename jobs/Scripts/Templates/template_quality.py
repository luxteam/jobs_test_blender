...
if __name__ == "__main__":
	...
	list_tests = [
	["BL_RS_QL_001", ["Max Ray Depth - 2"], "Quality.blend", 2, 3, 5, 5, 5, 5, 0.02, True, 1], 
	["BL_RS_QL_002", ["Max Ray Depth - 50"], "Quality.blend", 50, 3, 5, 5, 5, 5, 0.02, True, 1], 
	["BL_RS_QL_003", ["Max Diffuse - 2"], "Quality.blend", 8, 2, 5, 5, 5, 5, 0.02, True, 1], 
	["BL_RS_QL_004", ["Max Diffuse - 50"], "Quality.blend", 8, 50, 5, 5, 5, 5, 0.02, True, 1], 
	["BL_RS_QL_005", ["Max Glossy - 2"], "Quality.blend", 8, 3, 2, 5, 5, 5, 0.02, True, 1], 
	["BL_RS_QL_006", ["Max Glossy - 50"], "Quality.blend", 8, 3, 50, 5, 5, 5, 0.02, True, 1], 
	["BL_RS_QL_007", ["Max Refraction - 1"], "Quality.blend", 8, 3, 5, 1, 5, 5, 0.02, True, 1], 
	["BL_RS_QL_008", ["Max Refraction - 50"], "Quality.blend", 8, 3, 5, 50, 5, 5, 0.02, True, 1], 
	["BL_RS_QL_009", ["Max Glossy Refraction - 1"], "Quality.blend", 8, 3, 5, 5, 1, 5, 0.02, True, 1], 
	["BL_RS_QL_010", ["Max Glossy Refraction - 50"], "Quality.blend", 8, 3, 5, 5, 50, 5, 0.02, True, 1], 
	["BL_RS_QL_011", ["Max Shadow - 1"], "Quality.blend", 8, 3, 5, 5, 5, 1, 0.02, True, 1], 
	["BL_RS_QL_012", ["Max Shadow - 50"], "Quality.blend", 8, 3, 5, 5, 5, 50, 0.02, True, 1], 
	["BL_RS_QL_013", ["Ray Cast Epsilon - 0"], "Quality.blend", 8, 3, 5, 5, 5, 5, 0, True, 1], 
