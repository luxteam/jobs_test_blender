...
def prerender(test_list):
	...
	bpy.context.scene.node_tree.links.new(render_layer.outputs[test_list[2]], file_output.inputs[test_list[3]])

	bpy.context.scene.render.layers.active.rpr_data.passes_aov.enable = True

	bpy.context.scene.render.layers.active.rpr_data.passes_aov.passesStates[test_list[3]] = True
	render(test_list[0], test_list[1])
	bpy.context.scene.render.layers.active.rpr_data.passes_aov.passesStates[test_list[3]] = False
...
if __name__ == "__main__":
	...
	list_tests = [
	["BL_RS_AOV_001", ["AOV: Combined"], 'Image', 0], 
	["BL_RS_AOV_002", ["AOV: Depth"], 'Depth', 1], 
	["BL_RS_AOV_003", ["AOV: UV"], 'UV', 2], 
	["BL_RS_AOV_004", ["AOV: Object Index"], 'Object Index', 3], 
	["BL_RS_AOV_005", ["AOV: Material Index"], 'Material Index', 4], 
	["BL_RS_AOV_006", ["AOV: World Coordinate"], 'World Coordinate', 5],
	["BL_RS_AOV_007", ["AOV: Geometric Normal"], 'Geometric Normal', 6], 
	["BL_RS_AOV_008", ["AOV: Shading Normal"], 'Shading Normal', 7], 
	["BL_RS_AOV_009", ["AOV: Group Index"], 'Group Index', 8],
	...
	["BL_RS_AOV_017", ["AOV: Direct Diffuse"], 'Direct Diffuse', 16], 
