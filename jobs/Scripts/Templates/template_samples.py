...
def main(iterations):
	...
	bpy.data.scenes[Scenename].rpr.render.rendering_limits.iterations = iterations
	...
	# output
	name_scene = bpy.path.basename(bpy.context.blend_data.filepath) + "_" + str(iterations)
	...
	# LOG
	name_scene_for_json = bpy.path.basename(bpy.context.blend_data.filepath)  + "_" + str(iterations) + "BL"
