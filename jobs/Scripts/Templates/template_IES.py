...
def main(i):
	...
	bpy.data.lamps["Lamp"].rpr_lamp.ies_file_name = os.path.join(r"C:\TestResources\BlenderAssets\scenes\ies", i)

	# output
	name_scene = bpy.path.basename(bpy.context.blend_data.filepath) + "_" + i
	...
	# LOG
	name_scene_for_json = bpy.path.basename(bpy.context.blend_data.filepath) + "_" + i + "BL"
	...
	report['file_name'] = bpy.path.basename(bpy.context.blend_data.filepath) + "_" + i + "_01.jpg"
