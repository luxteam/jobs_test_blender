...
if __name__ == "__main__":
	...
	list_tests = [
	["BL_RS_SS_001", ["Sun&Sky System: Analytical sky", "Azimuth: 0", "Altitude: 0", "Texture Resolution: normal"], "TestSunSky.blend", 'analytical_sky', 'normal', 0, 0],
	...
	["BL_RS_SS_004", ["Sun&Sky System: Analytical sky", "Azimuth: 90", "Altitude: 0", "Texture Resolution: normal"], "TestSunSky.blend", 'analytical_sky', 'normal', 1.5708, 0],
	...
	["BL_RS_SS_007", ["Sun&Sky System: Analytical sky", "Azimuth: 180", "Altitude: 0", "Texture Resolution: normal"], "TestSunSky.blend", 'analytical_sky', 'normal', 3.14159, 0],
	...
	["BL_RS_SS_010", ["Sun&Sky System: Analytical sky", "Azimuth: 270", "Altitude: 0", "Texture Resolution: normal"], "TestSunSky.blend", 'analytical_sky', 'normal', 4.71239, 0],
	...
	["BL_RS_SS_013", ["Sun&Sky System: Analytical sky", "Azimuth: 360", "Altitude: 0", "Texture Resolution: normal"], "TestSunSky.blend", 'analytical_sky', 'normal', 6.28319, 0],
	...
	["BL_RS_SS_016", ["Sun&Sky System: Date, Time and Location", "Location: Moscow", "Hour: 0", "Texture Resolution: normal"], "TestSunSky.blend", 'date_time_location', 'normal', 0, 1, "Moscow"],
	["BL_RS_SS_017", ["Sun&Sky System: Date, Time and Location", "Location: Moscow", "Hour: 6", "Texture Resolution: normal"], "TestSunSky.blend", 'date_time_location', 'normal', 6, 1, "Moscow"],
	...
	["BL_RS_SS_019", ["Sun&Sky System: Date, Time and Location", "Location: Moscow", "Hour: 18", "Texture Resolution: normal"], "TestSunSky.blend", 'date_time_location', 'normal', 18, 1, "Moscow"],
	["BL_RS_SS_020", ["Sun&Sky System: Date, Time and Location", "Location: Moscow", "Hour: 24", "Texture Resolution: normal"], "TestSunSky.blend", 'date_time_location', 'normal', 24, 1, "Moscow"],
	...
	["BL_RS_SS_027", ["Sun&Sky System: Date, Time and Location", "Location: Miami Beach", "Hour: 0", "Texture Resolution: normal"], "TestSunSky.blend", 'date_time_location', 'normal', 0, 1, "Miami_Beach"],
	...
	["BL_RS_SS_029", ["Sun&Sky System: Date, Time and Location", "Location: Miami Beach", "Hour: 24", "Texture Resolution: normal"], "TestSunSky.blend", 'date_time_location', 'normal', 24, 1, "Miami_Beach"],
	["BL_RS_SS_030", ["Sun&Sky System: Date, Time and Location", "Location: Canberra", "Hour: 0", "Texture Resolution: normal"], "TestSunSky.blend", 'date_time_location', 'normal', 0, 1, "Canberra"],
	...
	["BL_RS_SS_032", ["Sun&Sky System: Date, Time and Location", "Location: Canberra", "Hour: 24", "Texture Resolution: normal"], "TestSunSky.blend", 'date_time_location', 'normal', 24, 1, "Canberra"]
	]
